...
import com.github.chrisbanes.photoview.PictureLayout;
...
public class SimpleSampleActivity extends AppCompatActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        mPictureLayout = findViewById(R.id.photo_view);
        ...
        mPictureLayout.setDragListener(new PictureLayout.DragListener() {
            @Override
            public void onDragFinished() {
                if (mPhotoView.getAttacher().isZoom()){
                    mPictureLayout.backStatus();
                }else {
                    finish();
                }
            }
